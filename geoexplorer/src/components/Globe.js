    ...
    const onMouseClick = (event) => {
      ...
      if (intersects.length > 0) {
        ...
        if (intersectedObject.userData && intersectedObject.userData.name) {
          ...
          console.log(
            `Coordinates: Latitude = ${latLon.lat}, Longitude = ${latLon.lon}`
          );
        }
      } else {
    ...
    <div>
      ...
      {selectedCountry && (
        ...
        >
          ...
          <p>
            <strong>Currency(s):</strong> {selectedCountry.currency}{" "}
            {"(" + selectedCountry.code + ")"}
          </p>
          <p>
            <strong>Language(s):</strong> {selectedCountry.languages}
          </p>
        </div>
      )}
